...
public class TodayZuiMeiFragment extends BaseFragment implements MyItemClickListener {
    String url = "http://lab.zuimeia.com/wallpaper/category/1/?appVersion=2.6" +
