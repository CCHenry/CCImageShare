package com.example.henryzheng.ccimageshare.C.ImageShowRecycle;
...
//                .setCircular(true)
     ...
     * @param imageInfos
     */
    public void addSrc(List<String> imageInfos) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        x.image().bind(holder.iv, urls.get(position), _imageOptions, new CustomBitmapLoadCallBack(holder));
...
//        int height=(int)(width*3/4+Math.random()*(width*7/4-width*3/4+1));
    ...
    /**
     * 加载图片
     * @param imageInfos 图片url的集合
     */
    public void loadImageList(List<String> imageInfos) {
        addSrc(imageInfos);
